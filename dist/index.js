import { elizaLogger, composePromptFromState, ModelType, parseKeyValueXml } from '@elizaos/core';
import { isAddress, parseUnits, createWalletClient, http, createPublicClient, formatUnits } from 'viem';
...
external_exports.object({
  [ENV_KEYS.ZYTRON_PRIVATE_KEY]: external_exports.string().min(1, "Zytron private key is required")
});
...
var checkWalletAction = {
  ...
  handler: async (runtime, message, state, _options, callback) => {
    ...
    const address = ((content == null ? void 0 : content.address) || "").trim() || walletProvider.getWalletAddress();
    try {
